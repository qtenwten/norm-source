...
]) expect(production.includes(token), `hybrid sample engine is incomplete: ${token}`)
...
if (!process.exitCode) console.log('AUDIO LIBRARY CONTRACT: OK // deterministic 18-cue sprite + 4 scene ambiences + procedural fallback')
