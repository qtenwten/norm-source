import{M as e,N as t,d as n,h as r,j as i,m as a,p as o,u as s}from"./index-Bme683zk.js";var c=t(e(),1),l=a(),u={restricted:{level:1,code:`17-B`,eyebrow:`N.O.R.M. // RESTRICTED DATABASE`,title:`ЗАКРЫТЫЙ СЕКТОР`,subtitle:`Материалы, исключённые из публичного архива. Доступ предоставлен текущей сессии.`,discovery:`RESTRICTED_VISITED`,notice:`Часть документов разрешено вынести за пределы NORM-OS для автономного анализа. Система не контролирует содержимое после скачивания.`,records:[{id:`17B-LM005-POST`,type:`ПОСТОПЕРАЦИОННЫЙ ЖУРНАЛ`,title:`LM-005 // сигнал после закрытия дела`,summary:`Необработанная выгрузка датчиков после официальной нейтрализации Ночного Душнилы.`,filename:`17B_LM005_POST_OPERATION.txt`,discovery:`DOWNLOAD_LM005_POST`,content:`N.O.R.M. // RESTRICTED 17-B
