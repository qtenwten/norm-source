import{D as e,E as t,O as n,a as r,c as i,i as a,l as o,s}from"./index-CyCPzX-J.js";var c=n(e(),1),l=i(),u={restricted:{level:1,code:`17-B`,eyebrow:`N.O.R.M. // RESTRICTED DATABASE`,title:`ЗАКРЫТЫЙ СЕКТОР`,subtitle:`Материалы, исключённые из публичного архива. Доступ предоставлен текущей сессии.`,discovery:`RESTRICTED_VISITED`,notice:`Часть документов разрешено вынести за пределы NORM-OS для автономного анализа. Система не контролирует содержимое после скачивания.`,records:[{id:`17B-LM005-POST`,type:`ПОСТОПЕРАЦИОННЫЙ ЖУРНАЛ`,title:`LM-005 // сигнал после закрытия дела`,summary:`Необработанная выгрузка датчиков после официальной нейтрализации Ночного Душнилы.`,filename:`17B_LM005_POST_OPERATION.txt`,discovery:`DOWNLOAD_LM005_POST`,content:`N.O.R.M. // RESTRICTED 17-B
...
`}]}};function d(e,t){if(!e.dynamic)return e.content;let n=sessionStorage.getItem(`norm-operator`)||`GUEST`;return`N.O.R.M. // ROOT SESSION TRACE\nGENERATED: ${new Date().toISOString()}\nOPERATOR: ${n}\nACCESS: A-${t.clearance}\nDISCOVERIES: ${t.discoveries.length}\n\nSESSION OBSERVER REGISTERED.\nSOURCE OF REGISTRATION: UNKNOWN.\nNORM-0: ACTIVE\nSYSTEM PATHS: HIDDEN FROM ARCHIVE NAVIGATION\n`}function f(e,t){let n=d(e,t),r=new Blob([n],{type:`text/plain;charset=utf-8`}),i=URL.createObjectURL(r),a=document.createElement(`a`);a.href=i,a.download=e.filename,document.body.appendChild(a),a.click(),a.remove(),window.setTimeout(()=>URL.revokeObjectURL(i),1200)}function p({zone:e=`restricted`}){let n=u[e]||u.restricted,i=t(),[p,m]=(0,c.useState)(r),[h,g]=(0,c.useState)(null);(0,c.useEffect)(()=>s(m),[]),(0,c.useEffect)(()=>{p.clearance>=n.level&&a(n.discovery)},[n.discovery,n.level,p.clearance]);let _=p.clearance>=n.level,v=(0,c.useMemo)(()=>n.records.filter(e=>p.discoveries.includes(e.discovery)).length,[n.records,p.discoveries]),y=e=>{o.archive(),f(e,p),a(e.discovery)};return _?(0,l.jsxs)(`div`,{className:`page clearance-zone clearance-zone--${e}`,children:[(0,l.jsxs)(`header`,{className:`clearance-zone__head`,children:[(0,l.jsxs)(`div`,{children:[(0,l.jsx)(`small`,{children:n.eyebrow}),(0,l.jsx)(`h1`,{children:n.title}),(0,l.jsx)(`p`,{children:n.subtitle})]}),(0,l.jsxs)(`div`,{className:`clearance-zone__badge`,children:[(0,l.jsx)(`span`,{children:`СЕКТОР`}),(0,l.jsx)(`b`,{children:n.code}),(0,l.jsxs)(`small`,{children:[`ACCESS A-`,n.level,` VERIFIED`]})]})]}),(0,l.jsxs)(`div`,{className:`clearance-zone__notice`,children:[(0,l.jsx)(`span`,{children:`⚠`}),(0,l.jsx)(`p`,{children:n.notice})]}),(0,l.jsxs)(`div`,{className:`clearance-zone__stats`,children:[(0,l.jsxs)(`span`,{children:[`ДОСТУП `,(0,l.jsxs)(`b`,{children:[`A-`,p.clearance]})]}),(0,l.jsxs)(`span`,{children:[`ФАЙЛОВ `,(0,l.jsx)(`b`,{children:n.records.length})]}),(0,l.jsxs)(`span`,{children:[`СКАЧАНО `,(0,l.jsx)(`b`,{children:v})]}),(0,l.jsx)(`button`,{type:`button`,onClick:()=>i(`/terminal`),children:`FIELD TERMINAL →`})]}),(0,l.jsx)(`div`,{className:`classified-grid`,children:n.records.map((e,t)=>(0,l.jsxs)(`article`,{className:`classified-file`,style:{"--delay":`${t*70}ms`},children:[(0,l.jsxs)(`div`,{className:`classified-file__mark`,children:[(0,l.jsx)(`span`,{children:String(t+1).padStart(2,`0`)}),(0,l.jsx)(`i`,{})]}),(0,l.jsx)(`small`,{children:e.type}),(0,l.jsx)(`h2`,{children:e.title}),(0,l.jsx)(`p`,{children:e.summary}),(0,l.jsxs)(`dl`,{children:[(0,l.jsx)(`dt`,{children:`INDEX`}),(0,l.jsx)(`dd`,{children:e.id}),(0,l.jsx)(`dt`,{children:`EXPORT`}),(0,l.jsx)(`dd`,{children:e.filename}),(0,l.jsx)(`dt`,{children:`CHECKSUM`}),(0,l.jsx)(`dd`,{children:p.discoveries.includes(e.discovery)?`DOWNLOADED`:`UNREAD`})]}),(0,l.jsxs)(`div`,{className:`classified-file__actions`,children:[(0,l.jsx)(`button`,{type:`button`,"data-sound":`drawer`,onClick:()=>{o.drawer(),g(e)},children:`ПРОСМОТРЕТЬ`}),(0,l.jsx)(`button`,{type:`button`,"data-sound":`terminal`,onClick:()=>y(e),children:`⇩ СКАЧАТЬ ФАЙЛ`})]})]},e.id))}),h&&(0,l.jsx)(`div`,{className:`classified-viewer`,role:`dialog`,"aria-modal":`true`,onClick:()=>g(null),children:(0,l.jsxs)(`section`,{onClick:e=>e.stopPropagation(),children:[(0,l.jsxs)(`header`,{children:[(0,l.jsxs)(`div`,{children:[(0,l.jsxs)(`small`,{children:[n.code,` // SECURE PREVIEW`]}),(0,l.jsx)(`b`,{children:h.id})]}),(0,l.jsx)(`button`,{type:`button`,onClick:()=>g(null),children:`×`})]}),(0,l.jsx)(`pre`,{children:d(h,p)}),(0,l.jsxs)(`footer`,{children:[(0,l.jsx)(`span`,{children:`Предпросмотр показывает тот же текст, который будет сохранён на компьютер.`}),(0,l.jsxs)(`button`,{type:`button`,onClick:()=>y(h),children:[`⇩ СКАЧАТЬ `,h.filename]})]})]})})]}):(0,l.jsx)(`div`,{className:`page clearance-zone clearance-zone--locked`,children:(0,l.jsxs)(`section`,{className:`clearance-denied`,children:[(0,l.jsx)(`small`,{children:n.eyebrow}),(0,l.jsx)(`strong`,{children:`ACCESS DENIED`}),(0,l.jsx)(`h1`,{children:n.title}),(0,l.jsxs)(`p`,{children:[`Текущая сессия имеет уровень A-`,p.clearance,`. Для этого раздела требуется A-`,n.level,`.`]}),(0,l.jsxs)(`div`,{children:[(0,l.jsx)(`span`,{children:`СЕКТОР СУЩЕСТВУЕТ`}),(0,l.jsx)(`span`,{children:`СОДЕРЖИМОЕ СКРЫТО`}),(0,l.jsx)(`span`,{children:`МАРШРУТ ЗАРЕГИСТРИРОВАН`})]}),(0,l.jsx)(`button`,{type:`button`,onClick:()=>i(`/terminal`),children:`ПЕРЕЙТИ В ТЕРМИНАЛ →`})]})})}export{p as default};