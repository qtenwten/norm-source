...
const monsters = [
  {
    ...
    hotspots:[
      ...
      {n:'02',x:80,y:31,title:'ГОЛОВА',body:'Визуальная реконструкция подчёркивает низкую посадку головы и амфибийные черты.'},
  ...
  },
  {
    ...
    hotspots:[
      {n:'01',x:31,y:24,title:'ЦИФРОВОЙ ШУМ',body:'Визуальная реконструкция связывает проявление с экранной и игровой средой.'},
